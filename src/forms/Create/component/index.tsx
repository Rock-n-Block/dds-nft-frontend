...
import { Uploader, ChooseCollection } from '../../../components/organisms';
...
const CreateForm: React.FC<FormikProps<ICreateForm> & ICreateForm> = ({
  setFieldValue,
  values,
  touched,
  errors,
          ...
          {values.unlockOncePurchased && (
            <>
              <Form.Item
                ...
                label={<span className="input__label text-bold">Digital key, code to redeem</span>}
              >
                <div className="input__field-create box-shadow">
                  <Input
                    id="digitalKey"
